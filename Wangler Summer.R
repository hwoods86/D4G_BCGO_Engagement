...
## Datasets
# att_checkin_summer: Check-in, M/X/Q, !V, !-1, summer
# mem_filtered: mem_type = M/Q, id != -1
# att_checkin_Summer_overlap : found in member_df
##
...
# Table: Member Check-Ins For Summer Period (Sept 2009 to June 2018)

att_checkin_Summer <- att_checkin %>%
...
# Table: Member Check-ins
att_checkin_Summer_overlap <- att_checkin_Summer %>%
